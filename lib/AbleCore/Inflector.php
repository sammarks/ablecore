 ...
 * if Drupal supported it.
 *
 * This class is a slightly modified version of the Inflector class from
 * the Akelos Framework (https://github.com/akelos) and the original source
 * was found here (http://subosito.com/inflector-in-symfony-2/).
 *
 * Thanks to the maintainers of the Akelos Framework for providing this base
 * class for Able Core.
 */
...
class Inflector {
	...
	/**
	 * Converts a singular or plural English word into the form
	 * that fits the quantity specified (singular for 1, plural for
	 * everything else).
	 *
	 * @param int    $quantity The quantity to use when converting the word.
	 * @param string $word     The word to quantize.
	 *
	 * @return string The quantized word (without the number).
	 */
	public function quantize($quantity, $word)
	{
		if ($quantity === 1) {
